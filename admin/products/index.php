                        ...
                        <table class="table table-striped item-list">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="item-list-title" style="width: 10%">Name</th>
                                    <th scope="col" class="item-list-title" style="width: 10%">Size</th>
                                    <th scope="col" class="item-list-title" style="width: 20%">Matrial</th>
                                    <th scope="col" class="item-list-title" style="width: 20%">Threads</th>
                                    <th scope="col" class="item-list-title" style="width: 20%">Plating</th>
                                    <th scope="col" class="item-list-title" style="width: 50%">Description</th>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($rows); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-list-name"><?= $rows[$i]['Size'] ?></td>
                                        <td class="item-list-name"><?= $rows[$i]['Material'] ?></td>
                                        <td class="item-list-name"><?= $rows[$i]['Threads'] ?></td>
                                        <td class="item-list-name"><?= $rows[$i]['Plating'] ?></td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button id="btn-yes" type="button" class="btn btn-danger" data-id="<?=$id?>" onclick="deleteProduct()">Yes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
